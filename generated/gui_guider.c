...
void init_scr_del_flag(lv_ui *ui)
{
	...
	ui->menuPage_del = true;
	ui->dataPage_del = true;
	ui->settingsPage_del = true;
	ui->functionPage_del = true;
	ui->musicPage_del = true;
}

void setup_ui(lv_ui *ui)
{
	init_scr_del_flag(ui);
	setup_scr_menuPage(ui);
	lv_scr_load(ui->menuPage);
}
